...
const MyExpertise = () => {
            ...
            <section className="py-20 px-4 text-center">
                <div className="mx-auto max-w-3xl rounded-xl border border-[#30363d] bg-[#0d1117] p-10">
                    <h2 className="mb-4 text-2xl font-semibold text-[#f85149]">
                        Failed to load expertise
                    </h2>
                    <p className="text-[#8b949e]">
                        Something went wrong while fetching the skill matrix.
                    </p>
    ...
    return (
        <section className="relative bg-[#0d1117] py-20 md:py-28 lg:py-36 border-t border-[#21262d]">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                {/* Header estilo GitHub section */}
                <div className="mt-64 mb-12 md:mb-16 text-center">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight">
                        Expertise
                    </h2>
                    <p className="mt-3 text-lg text-[#8b949e]">
                        Core technologies & skills I work with daily
                    </p>
                </div>
                ...
                <motion.div
                    ...
                    className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6 md:gap-8"
                >
                    {isLoading
